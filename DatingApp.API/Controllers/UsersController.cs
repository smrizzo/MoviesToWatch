...
namespace DatingApp.API.Controllers
{
  ...
  public class UsersController : ControllerBase
  {
    ...
    // Using autoMapper to map the fields from user model to the ones we want to return
    // which are specified in the Dtos
    // [HttpGet]
    ...
    //   _repo.Add<Like>(like);//this just saves to memory not database
